...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-adminlte-1739978638) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-adminlte-1739978638.git
$ cd django-adminlte-1739978638
```
